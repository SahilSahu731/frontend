...
const Player = () => {
    ...
    const { seekBar,track, seekBg, playStatus, play ,pause,time,previous,seekSong, next} = useContext(PlayerContext)
        ...
        <div className="flex flex-col items-center gap-1 m-auto">
            ...
            <div className="flex items-center gap-5">
                ...
                <div onClick={seekSong} ref={seekBg} className="w-[60vw] max-w-[500px] bg-gray-300 rounded-full ">
                    <hr ref={seekBar} className="h-1 cursor-pointer border-none w-0 bg-green-800 rounded-full" />
                </div>
